...
async function setupTrash() {
    ...
    const amountRaisedLeft = Math.max(MaxMoneyRaised - amountRaised, 0);
    const stringifiedAmount = trashFormatter.format(amountRaisedLeft);
    const trashAmount = {
        xxl: {
